...
public class Exercicio15 {
    public static void executar() {
        ...
        // desconto.
        // Façaum programa que calcule e exiba o valor do desconto e o valor a ser pago
        // pelo cliente.
        // O descontodeverá ser calculado sobre o valor do veículo de acordo com o
        // combustível
        // (álcool – 25%, gasolina– 21% ou diesel –14%).
        // Com valor do veículo zero encerra entrada de dados. Informe total dedesconto
        ...
        while (true) {
            String tipoCombustivel = Prompt
                    .lerLinha("Digite o tipo de combustível (álcool, gasolina, diesel) ou '0' para encerrar: ");

            if (tipoCombustivel.equalsIgnoreCase("álcool") || tipoCombustivel.equalsIgnoreCase("gasolina")
                    || tipoCombustivel.equalsIgnoreCase("diesel")) {
