...
public class Exercicio25 {
    public static void executar() {
        ...
        // três notas acimamencionadas,
        // desenvolva um programa para calcular a nota final e a classificação de
        // cadaestudante.
        // A classificação é dada conforme a lista abaixo:Nota Final Classificação[8,10]
        // A[7,8] B[6,7] C[5,6] D[0,5]
